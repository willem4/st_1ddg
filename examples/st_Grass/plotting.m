...
for kk = 1:length(ext)
    ...
    gg = 3;
    subplot (2,1,jj)
    plot(a(1,(jj-1)*Nn+1:jj*Nn),a(2,(jj-1)*Nn+1:jj*Nn)+a(2,(gg-1)*Nn+1:gg*Nn),'-');
    hold on;
    plot(b(1,(jj-1)*Nn+1:jj*Nn),b(2,(jj-1)*Nn+1:jj*Nn)+b(2,(gg-1)*Nn+1:gg*Nn),'g-');
    plot(a(1,(jj-1)*Nn+1:jj*Nn),a(2,(gg-1)*Nn+1:gg*Nn),'b-');
    plot(b(1,(jj-1)*Nn+1:jj*Nn),b(2,(gg-1)*Nn+1:gg*Nn),'g-');    
    hold off;
    jj = 2;
    gg = 1;
    subplot (2,1,jj)
    %plot(a(1,(jj-1)*Nn+1:jj*Nn),0.9055*(a(2,(jj-1)*Nn+1:jj*Nn)./a(2,(gg-1)*Nn+1:gg*Nn)).^3,'-');
    plot(a(1,(jj-1)*Nn+1:jj*Nn),a(2,(jj-1)*Nn+1:jj*Nn),'b-');
    hold on;
    %subplot (M1,1,jj)
    %plot(b(1,(jj-1)*Nn+1:jj*Nn),0.9055*(b(2,(jj-1)*Nn+1:jj*Nn)./b(2,(gg-1)*Nn+1:gg*Nn)).^3,'g-');
